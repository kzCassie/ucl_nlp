...
. scripts/tranX/test.sh saved_models/conala/${model_name}.bin ${mined_num} ${parser} 2>&1 | tee -a logs/conala/${model_name}.log
...
. scripts/tranX/test.sh saved_models/conala/${finetuned_model_name}.bin ${mined_num} ${parser} 2>&1 | tee -a logs/conala/${finetuned_model_name}.log